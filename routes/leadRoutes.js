...
router.get('/getProductToBePromoted',leadController.getProductToBePromoted);
...
router.get('/getCustomerTypeForEnviroSolution',leadController.getCustomerTypeForEnviroSolution);
